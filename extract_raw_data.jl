...
outDir = "C:/Users/coumesa/Documents/BCI/data/processed_data_raw"    # output to save the tensor 
...
for DB ∈ DBs
    ...
    for (d, file) in enumerate(DB.files)
        ...
        o = readNY(file; bandPass = (4, 36), upperLimit = 1.2, classes) # verify for artefact and bandPass
